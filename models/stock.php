<?php
    ...
    Class InventarioPDO extends ConexionPDO{
        ...
        function __construct($product_id='',$cod='',$nom='', $price='', $desc=''){
            parent::__construct();
        ...
        public function get_productos(){
            $this->conectar();
            $stmt = $this->conexion->prepare("SELECT id, codigo, nombre, precio, descripcion
            FROM inventario");
            $stmt->execute();
        ...
        public function get_producto($product_id){
            ...
            $sql = "SELECT id, codigo, nombre, precio, descripcion FROM inventario
            WHERE id = '$product_id'";
        ...
        public function crear_producto(){
            $this->conectar();
            try {
                $sql = "INSERT INTO inventario (codigo, nombre, precio, descripcion) 
                VALUES('$this->codigo','$this->nombre','$this->precio','$this->descripcion')";
